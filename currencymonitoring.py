...
while True:
    ...
    dolarmsg = "1USD = " + str(roundeddolar) + "TL"
    ...
    ## ÇeyrekAltınAlış
    urlua1 = "https://bigpara.hurriyet.com.tr/altin/ceyrek-altin-fiyati/#:~:text=%C3%87eyrek%20Alt%C4%B1n%20fiyat%C4%B1%20ne%20kadar,sat%C4%B1%C5%9F%20fiyat%C4%B1%202800%20TL%20%C5%9Feklindedir."
    sayfa3 = requests.get(urlua1)
    html_sayfa3 = BeautifulSoup(sayfa3.content, "html.parser")
    ua1 = html_sayfa3.find("span", class_="value up").getText()
    ua1msg = "Ceyrek Alis = " + str(ua1) + "TL"
